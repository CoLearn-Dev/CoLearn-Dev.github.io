...
| InterCoreSyncTaskWithReverseConnection | [Task](#colink-Task) | [Task](#colink-Task) stream | InterCore RPC. Same as InterCoreSyncTask and create a reverse connection. Require guest or user JWT. |

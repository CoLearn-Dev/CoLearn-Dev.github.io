...
| ----------- | ------------ | ------------- | ------------|
| GenerateToken | [GenerateTokenRequest](#colink-GenerateTokenRequest) | [Jwt](#colink-Jwt) | Given a valid JWT and a expiration timestamp, generates a new JWT with the expiration time set to the input timestamp. Requires user jwt. You cannot refresh a host JWT. |
...
| InterCoreSyncTaskWithReverseConnection | [Task](#colink-Task) | [Task](#colink-Task) stream | InterCore RPC. Same as InterCoreSyncTask and create a reverse connection. The requestor of this RPC grants guest privilege for this reverse connection. Require guest or user JWT. |

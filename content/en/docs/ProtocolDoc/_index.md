...
| ----------- | ------------ | ------------- | ------------|
| GenerateToken | [GenerateTokenRequest](#colink-GenerateTokenRequest) | [Jwt](#colink-Jwt) | Given a valid JWT and a expiration timestamp, generates a new JWT with the expiration time set to the input timestamp. Requires user jwt. You cannot refresh an host JWT. |
